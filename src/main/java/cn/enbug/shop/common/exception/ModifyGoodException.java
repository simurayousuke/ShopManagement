...
public class ModifyGoodException extends ShopException {
     ...
     * @see RuntimeException#RuntimeException()
     */
    public ModifyGoodException(String message) {
        super(message);
    }
     ...
     * @see RuntimeException#RuntimeException()
     */
    public ModifyGoodException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @see RuntimeException#RuntimeException()
     */
    public ModifyGoodException(Throwable cause) {
        super(cause);
    }
