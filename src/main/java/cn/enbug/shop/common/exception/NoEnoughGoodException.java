...
public class NoEnoughGoodException extends RuntimeException {
     ...
     * @see RuntimeException#RuntimeException()
     */
    public NoEnoughGoodException(String message) {
        super(message);
    }
     ...
     * @see RuntimeException#RuntimeException()
     */
    public NoEnoughGoodException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @see RuntimeException#RuntimeException()
     */
    public NoEnoughGoodException(Throwable cause) {
        super(cause);
    }
